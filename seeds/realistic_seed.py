...
COMPANIES: list[dict[str, Any]] = [
    # ── 1. PolMet S.A. — manufacturing/metalworking (PL)
    {
        ...
        "jobs": [
            ...
            {
                "title": "Brygadzista produkcji",
                "category": "mfg_team_leader",
                "seniority": "team_leader",
                "loc": "Katowice",
                "salary": (7000, 10000),
                "shift": "three_shift",
            },
            {
                "title": "Mechanik utrzymania ruchu",
                "category": "mfg_maintenance",
                "seniority": "worker",
                "loc": "Katowice",
                "salary": (6500, 9500),
            },
            {
                ...
                "category": "mfg_industrial_electrician",
                "seniority": "worker",
                "loc": "Gliwice",
                "salary": (6800, 10000),
                "quals": ["sep_g1", "sep_g2"],
            ...
            {
                "title": "Operator linii lakierniczej",
                "category": "mfg_painter",
                "seniority": "operator",
                "loc": "Katowice",
                "salary": (5000, 7500),
                "shift": "two_shift",
    ...
    # ── 2. GreenLine Sp. z o.o. — food production (PL)
    {
        ...
        "jobs": [
            {
                "title": "Pracownik produkcji żywności",
                "category": "mfg_operator",
                "seniority": "worker",
                "loc": "Poznań",
                "salary": (4500, 6200),
                "shift": "three_shift",
                "quals": ["health_card", "haccp"],
            },
            {
                "title": "Operator linii pakującej",
                "category": "mfg_machine_operator",
                "seniority": "operator",
                "loc": "Poznań",
                "salary": (4800, 6800),
                "shift": "two_shift",
            ...
            {
                "title": "Magazynier chłodni",
                "category": "log_warehouse_op",
                "seniority": "worker",
                "loc": "Poznań",
                "salary": (5000, 7000),
                "quals": ["forklift_udt", "health_card"],
            },
            {
                "title": "Brygadzista zmiany",
                "category": "mfg_team_leader",
                "seniority": "team_leader",
                "loc": "Poznań",
                "salary": (6500, 9000),
            ...
            },
            {
                ...
                "category": "fin_quality_analyst" if False else "sci_chemist",
                "seniority": "specialist",
                "loc": "Poznań",
                "salary": (7500, 11000),
            },
            {
                "title": "Kierownik zmiany",
                "category": "mfg_manager",
                "seniority": "manager",
                "loc": "Poznań",
                "salary": (10000, 14000),
        ...
        "jobs": [
            {
                ...
                "salary": (18000, 26000),
                "work_mode": "remote",
                "techs": ["Python", "FastAPI", "PostgreSQL", "Redis", "Docker", "AWS"],
            },
            {
            ...
            },
            {
                ...
                "category": "it_fullstack",
                "seniority": "mid",
                "loc": "Wrocław",
                "salary": (13000, 19000),
                "work_mode": "hybrid",
                "techs": ["TypeScript", "Node.js", "React", "PostgreSQL"],
            },
            {
                ...
                "salary": (20000, 28000),
                "work_mode": "remote",
                "techs": ["AWS", "Terraform", "Kubernetes", "GitHub Actions"],
                "quals": ["aws_cert"],
            },
            {
                "title": "QA Automation Engineer",
                "category": "it_qa_automation",
                "seniority": "mid",
                "loc": "Wrocław",
                "salary": (12000, 17000),
                "work_mode": "hybrid",
                "techs": ["Playwright", "TypeScript", "Pytest"],
            },
            {
                ...
                "salary": (16000, 23000),
                "work_mode": "remote",
                "techs": ["Swift", "SwiftUI", "Combine"],
            },
            {
                "title": "Data Engineer",
                "category": "it_data_engineer",
                "seniority": "senior",
                "loc": "Wrocław",
                "salary": (17000, 24000),
                "work_mode": "hybrid",
                "techs": ["Python", "Snowflake", "dbt", "Airflow"],
            },
            {
                "title": "ML Engineer",
                "category": "it_data_scientist",
                "seniority": "senior",
                "loc": "Remote (EU)",
                "salary": (19000, 27000),
                "work_mode": "remote",
                "techs": ["Python", "PyTorch", "MLflow", "AWS SageMaker"],
            },
            {
            ...
            },
            {
                ...
                "category": "it_solutions_architect",
                "seniority": "lead",
                "loc": "Remote (EU)",
                "salary": (24000, 34000),
                "work_mode": "remote",
                "techs": ["AWS", "Microservices", "EDA"],
                "quals": ["aws_cert"],
            },
            {
    ...
    # ── 4. Velvet Hotels Group — hospitality (EN)
    {
        ...
        "jobs": [
            {
                "title": "Hotel Receptionist (Warsaw)",
                "category": "hsp_hotel_receptionist",
                "loc": "Warszawa",
                "salary": (5000, 7000),
                "shift": "three_shift",
            },
            {
                "title": "Hotel Receptionist (Kraków)",
                "category": "hsp_hotel_receptionist",
                "loc": "Kraków",
                "salary": (4800, 6800),
                "shift": "three_shift",
            ...
            {
                "title": "Concierge",
                "category": "cs_concierge",
                "loc": "Kraków",
                "salary": (5500, 7500),
            },
            {
                "title": "Hotel Manager",
                "category": "hsp_hotel_manager",
                "seniority": "manager",
                "loc": "Gdańsk",
                "salary": (16000, 22000),
            },
            {
                "title": "F&B Manager",
                "category": "hsp_restaurant_manager",
                "seniority": "manager",
                "loc": "Warszawa",
                "salary": (13000, 18000),
            },
        ...
        "jobs": [
            {
                ...
                "category": "hc_physician_specialist",
                "seniority": "attending",
                "loc": "Kraków",
                "salary": (18000, 28000),
                "quals": ["medical_license"],
            },
            {
            ...
            },
            {
                ...
                "category": "hc_psychologist",
                "seniority": "specialist",
                "loc": "Kraków",
                "salary": (8500, 12000),
            },
            {
                "title": "Technik elektroradiolog",
                "category": "hc_xray_technician",
                "loc": "Kraków",
                "salary": (6800, 9000),
                "shift": "two_shift",
            },
    ...
    # ── 6. Białowieskie Tartaki (PL)
    {
        ...
        "jobs": [
            {
                "title": "Operator tartaku",
                "category": "agr_forestry",
                "loc": "Hajnówka",
                "salary": (4800, 6800),
                "shift": "two_shift",
                "quals": ["bhp"],
            ...
            {
                "title": "Drwal",
                "category": "agr_lumberjack",
                "loc": "Białowieża",
                "salary": (5000, 7000),
                "quals": ["bhp", "driving_b"],
            },
            {
                "title": "Pracownik leśny",
                "category": "agr_forestry",
                "loc": "Hajnówka",
                "salary": (4500, 6200),
                "quals": ["bhp"],
            ...
            {
                "title": "Kierownik produkcji drewna",
                "category": "agr_farm_manager",
                "seniority": "manager",
                "loc": "Hajnówka",
                "salary": (9000, 13000),
            },
            {
                "title": "Operator suszarni",
                "category": "mfg_machine_operator",
                "loc": "Hajnówka",
                "salary": (5500, 7500),
                "shift": "two_shift",
    ...
    # ── 7. Solaris Energia (PL)
    {
        ...
        "jobs": [
            {
                "title": "Operator elektrowni",
                "category": "enr_power_plant_op",
                "loc": "Szczecin",
                "salary": (6500, 9000),
                "shift": "three_shift",
                "quals": ["sep_g1", "sep_g2", "sep_g3"],
            },
            {
                "title": "Monter linii energetycznych",
                "category": "enr_linesman",
                "loc": "Poznań",
                "salary": (6000, 8500),
                "quals": ["sep_g1", "bhp"],
            },
            {
                "title": "Instalator paneli fotowoltaicznych",
                "category": "enr_solar_installer",
                "loc": "Wrocław",
                "salary": (5800, 8200),
                "quals": ["sep_g1"],
            },
            {
                "title": "Technik turbin wiatrowych",
                "category": "enr_wind_turbine_tech",
                "loc": "Koszalin",
                "salary": (8000, 12000),
                "quals": ["bhp"],
            },
            ...
            {
                "title": "Specjalista BHP w energetyce",
                "category": "ops_business_analyst",
                "seniority": "specialist",
                "loc": "Poznań",
                "salary": (8000, 11000),
                "quals": ["bhp"],
    ...
    # ── 8. DigitalCanvas Agency (EN)
    {
        ...
        "jobs": [
            ...
            },
            {
                ...
                "category": "marketing_copywriting",
                "seniority": "senior",
                "loc": "Warszawa",
                "salary": (11000, 16000),
                "work_mode": "hybrid",
            ...
            },
            {
                ...
                "category": "marketing_social_media",
                "seniority": "specialist",
                "loc": "Warszawa",
                "salary": (8500, 12000),
                "work_mode": "hybrid",
    ...
    # ── 9. EuroBank Capital (EN)
    {
        ...
        "jobs": [
            ...
            },
            {
                ...
                "category": "fin_accountant",
                "seniority": "senior_specialist",
                "loc": "Warszawa",
                "salary": (12000, 17000),
                "work_mode": "hybrid",
            },
            ...
            },
            {
                ...
                "category": "fin_banking_investment",
                "seniority": "specialist",
                "loc": "Warszawa",
                "salary": (18000, 28000),
                "work_mode": "office",
            },
            {
                ...
                "category": "fin_banking_corporate",
                "seniority": "senior_specialist",
                "loc": "Warszawa",
                "salary": (15000, 22000),
                "work_mode": "hybrid",
        ...
        "jobs": [
            {
                ...
                "category": "log_driver_heavy",
                "loc": "Łódź",
                "salary": (8500, 13000),
                "quals": ["driving_ce"],
            },
            {
                "title": "Kierowca C krajowy",
                "category": "log_driver_heavy",
                "loc": "Łódź",
                "salary": (6500, 9500),
                "quals": ["driving_c"],
            ...
            },
            {
                ...
                "category": "log_freight_forwarder",
                "seniority": "specialist",
                "loc": "Łódź",
                "salary": (8000, 12000),
                "work_mode": "hybrid",
            },
            {
                ...
                "category": "log_warehouse_manager",
                "seniority": "manager",
                "loc": "Łódź",
                "salary": (11000, 15000),
            },
            {
                "title": "Koordynator logistyki",
                "category": "log_coordinator",
    ...
    # ── 11. MedicaPlus Clinic Network (EN)
    {
        ...
        "jobs": [
            ...
            {
                "title": "Pharmacist",
                "category": "hc_pharmacist",
                "loc": "Warszawa",
                "salary": (8500, 12000),
                "quals": ["pharmacy_license"],
            },
            {
        ...
        "jobs": [
            {
                ...
                "category": "con_foreman",
                "seniority": "foreman",
                "loc": "Warszawa",
                "salary": (9000, 13000),
                "quals": ["bhp", "construction_license"],
            },
            {
                "title": "Construction Manager",
                "category": "con_manager",
                "seniority": "manager",
                "loc": "Kraków",
                "salary": (15000, 22000),
                "quals": ["construction_license"],
            },
            {
                "title": "Site Engineer",
                "category": "con_architect_assistant",
                "seniority": "specialist",
                "loc": "Wrocław",
                "salary": (9000, 13000),
            },
            {
                "title": "Electrician",
                "category": "con_electrician",
                "loc": "Warszawa",
                "salary": (7000, 10000),
                "quals": ["sep_g1", "construction_license"],
            },
            {
                "title": "Plumber",
                "category": "con_plumber",
                "loc": "Gdańsk",
                "salary": (6500, 9500),
                "quals": ["bhp"],
            },
    ...
    # ── 13. TaxLab Doradztwo Podatkowe (PL)
    {
        ...
        "jobs": [
            ...
            {
                "title": "Aplikant adwokacki",
                "category": "legal_paralegal",
                "seniority": "specialist",
                "loc": "Kraków",
                "salary": (8000, 12000),
                "work_mode": "hybrid",
            ...
            {
                "title": "Specjalista ds. cen transferowych",
                "category": "fin_tax",
                "seniority": "senior_specialist",
                "loc": "Warszawa",
                "salary": (14000, 19000),
        ...
        "jobs": [
            {
                ...
                "category": "edu_language_tutor",
                "loc": "Warszawa",
                "salary": (4500, 7500),
                "quals": ["language_cert"],
            },
            {
                "title": "Lektor języka niemieckiego",
                "category": "edu_language_tutor",
                "loc": "Kraków",
                "salary": (4500, 7500),
                "quals": ["language_cert"],
            ...
            {
                "title": "Lektor języka hiszpańskiego",
                "category": "edu_language_tutor",
                "loc": "Wrocław",
                "salary": (4500, 7500),
                "quals": ["language_cert"],
            ...
            {
                "title": "Metodyk",
                "category": "edu_vocational_trainer",
                "seniority": "specialist",
                "loc": "Warszawa",
                "salary": (8000, 11000),
            },
            {
                "title": "Koordynator szkoły",
                "category": "edu_school_counselor",
                "seniority": "coordinator",
                "loc": "Poznań",
                "salary": (6500, 9000),
            },
            {
                "title": "Recepcjonista szkoły",
                "category": "cs_receptionist",
                "loc": "Warszawa",
                "salary": (4500, 6000),
            },
        ],
        ...
        "jobs": [
            {
                ...
                "category": "cln_residential_cleaner",
                "loc": "Warszawa",
                "salary": (4200, 5500),
            },
            {
                "title": "Commercial Cleaner (Warsaw)",
                "category": "cln_commercial_cleaner",
                "loc": "Warszawa",
                "salary": (4500, 6000),
                "shift": "two_shift",
            },
            {
                "title": "Janitor",
                "category": "cln_janitor",
                "loc": "Kraków",
                "salary": (4200, 5500),
            },
            {
                "title": "Window Cleaner (heights)",
                "category": "cln_window_cleaner",
                "loc": "Warszawa",
                "salary": (5500, 7500),
                "quals": ["bhp"],
            },
    ...
    # ── 16. AutoNova Garage Network (PL)
    {
        ...
        "jobs": [
            ...
            {
                "title": "Elektromechanik samochodowy",
                "category": "auto_electrician",
                "loc": "Kraków",
                "salary": (6500, 9500),
                "quals": ["sep_g1"],
            },
            {
                ...
                "category": "auto_body_repair",
                "loc": "Warszawa",
                "salary": (6000, 8800),
            },
            {
                "title": "Lakiernik samochodowy",
                "category": "auto_painter",
                "loc": "Wrocław",
                "salary": (5800, 8500),
            },
            {
                "title": "Doradca serwisowy",
                "category": "auto_service_advisor",
                "seniority": "specialist",
                "loc": "Warszawa",
                "salary": (7000, 10000),
            },
    ...
    # ── 17. Bezpieczeństwo24 Ochrona (PL)
    {
        ...
        "jobs": [
            {
                "title": "Pracownik ochrony (obiekt biurowy)",
                "category": "sec_security_guard",
                "loc": "Warszawa",
                "salary": (4800, 6500),
                "shift": "three_shift",
                "quals": ["security_license", "first_aid"],
            },
            {
                "title": "Pracownik ochrony (centrum handlowe)",
                "category": "sec_security_guard",
                "loc": "Kraków",
                "salary": (4500, 6200),
                "shift": "three_shift",
                "quals": ["security_license"],
            },
            {
                "title": "Konwojent",
                "category": "sec_cash_in_transit",
                "loc": "Warszawa",
                "salary": (6500, 9000),
                "quals": ["security_license", "driving_b"],
            },
            {
    ...
    # ── 18. Boutique Beauty Spa (EN)
    {
        ...
        "jobs": [
            ...
            },
            {
                ...
                "category": "bty_massage_therapist",
                "loc": "Warszawa",
                "salary": (5000, 8000),
                "quals": ["health_card"],
            },
        ...
        "jobs": [
            {
                ...
                "category": "eng_automation_robotics",
                "seniority": "senior",
                "loc": "Poznań",
                "salary": (15000, 22000),
                "work_mode": "hybrid",
            ...
            {
                "title": "R&D Engineer",
                "category": "sci_research_scientist",
                "seniority": "senior",
                "loc": "Poznań",
                "salary": (16000, 23000),
                "work_mode": "hybrid",
            ...
            },
            {
                ...
                "category": "it_embedded",
                "seniority": "mid",
                "loc": "Poznań",
                "salary": (13000, 18000),
                "work_mode": "hybrid",
                "techs": ["Siemens TIA", "Allen-Bradley", "Ladder Logic"],
            },
        ],
    },
    # ── 20. Okrąglak Retail (PL)
    {
        ...
        "jobs": [
            {
                "title": "Kasjer/-ka (Warszawa)",
                "category": "ret_cashier",
                "loc": "Warszawa",
                "salary": (4200, 5500),
                "shift": "two_shift",
            },
            {
                "title": "Sprzedawca / Doradca klienta",
                "category": "ret_sales_associate",
                "loc": "Wrocław",
                "salary": (4500, 6000),
            },
            {
                "title": "Kierownik sklepu",
                "category": "ret_store_manager",
                "seniority": "manager",
                "loc": "Kraków",
                "salary": (7500, 10500),
            },
            {
                ...
                "category": "ret_visual_merchandiser",
                "seniority": "specialist",
                "loc": "Łódź",
                "salary": (7500, 10000),
            },
            {
                "title": "Pracownik magazynu sklepowego",
                "category": "ret_stockroom",
                "loc": "Łódź",
                "salary": (4500, 6200),
            },
            {
                "title": "Senior Buyer",
                "category": "ret_buyer_merchandiser",
                "seniority": "senior_specialist",
                "loc": "Łódź",
                "salary": (12000, 17000),
                "work_mode": "hybrid",
    ...
    # ── 21. Randall & Partners Talent (EN)
    {
        ...
        "jobs": [
            {
                "title": "CFO for FinTech scale-up",
                "category": "fin_cfo",
                "seniority": "executive",
                "loc": "Warszawa",
                "salary": (40000, 70000),
            ...
            {
                "title": "Country Manager Poland (FMCG)",
            ...
            {
                "title": "Plant Director (Manufacturing)",
                "category": "mfg_plant_manager",
                "seniority": "director",
                "loc": "Gliwice",
                "salary": (28000, 42000),
            },
    ...
    # ── 22. Personalia HR Solutions (PL)
    {
        ...
        "jobs": [
            {
                "title": "Account Manager dla branży FMCG",
                "category": "sales_account_manager",
                "seniority": "specialist",
                "loc": "Warszawa",
                "salary": (10000, 14000),
            },
            {
                "title": "Junior Księgowa/-y",
                "category": "fin_accountant",
                "seniority": "junior",
                "loc": "Kraków",
                "salary": (5500, 7500),
            ...
            {
                "title": "Trener wewnętrzny (sieć retail)",
                "category": "edu_vocational_trainer",
                "seniority": "specialist",
                "loc": "Warszawa",
                "salary": (8000, 11000),
            ...
            {
                "title": "Kierownik produkcji (FMCG)",
                "category": "mfg_manager",
                "seniority": "manager",
                "loc": "Poznań",
                "salary": (13000, 18000),
    ...
    # ── 23. HireForce Recruitment (EN)
    {
        ...
        "jobs": [
            {
                "title": "Senior Java Developer for FinTech",
                "category": "it_backend",
                "seniority": "senior",
                "loc": "Remote (EU)",
                "salary": (20000, 28000),
                "work_mode": "remote",
                "techs": ["Java", "Spring Boot", "Kafka", "AWS"],
            },
            {
                "title": "DevOps Engineer for HealthTech",
                "category": "it_devops",
                "seniority": "senior",
                "loc": "Remote (EU)",
                "salary": (19000, 27000),
                "work_mode": "remote",
                "techs": ["Kubernetes", "AWS", "Terraform", "GitOps"],
            },
            {
                "title": "Mobile Developer iOS — gaming",
                "category": "it_mobile",
                "seniority": "senior",
                "loc": "Remote (EU)",
                "salary": (18000, 25000),
                "work_mode": "remote",
                "techs": ["Swift", "Metal", "GameKit"],
            },
            {
                "title": "Frontend Lead — e-commerce",
                "category": "it_frontend",
                "seniority": "lead",
                "loc": "Warszawa",
                "salary": (22000, 30000),
            ...
            },
            {
                ...
                "category": "it_cloud_architect",
                "seniority": "expert",
                "loc": "Remote (EU)",
                "salary": (25000, 35000),
                "work_mode": "remote",
                "techs": ["AWS", "Terraform", "Multi-region"],
                "quals": ["aws_cert"],
            },
            {
            ...
            {
                "title": "Data Scientist (e-commerce)",
                "category": "it_data_scientist",
                "seniority": "senior",
                "loc": "Remote (EU)",
                "salary": (18000, 26000),
                "work_mode": "remote",
                "techs": ["Python", "PyTorch", "BigQuery"],
            },
            {
                ...
                "salary": (16000, 22000),
                "work_mode": "hybrid",
                "techs": ["Playwright", "TypeScript", "K6"],
            },
            {
                "title": "Tech Lead — SaaS platform",
                "category": "it_solutions_architect",
                "seniority": "lead",
                "loc": "Remote (EU)",
                "salary": (24000, 33000),
    ...
    # ── 24. GlobalStaff Polska (PL)
    {
        ...
        "jobs": [
            {
                "title": "Operator linii produkcyjnej (Wrocław)",
                "category": "mfg_operator",
                "loc": "Wrocław",
                "salary": (4800, 6500),
                "shift": "three_shift",
            ...
            {
                "title": "Pracownik produkcji (różne kierunki)",
                "category": "mfg_operator",
                "loc": "Gdańsk",
                "salary": (4500, 6200),
                "shift": "three_shift",
            ...
            {
                "title": "Spawacz MAG (Wrocław)",
                "category": "mfg_welder",
                "loc": "Wrocław",
                "salary": (6000, 9000),
            },
            {
                "title": "Brygadzista — produkcja",
                "category": "mfg_team_leader",
                "seniority": "team_leader",
                "loc": "Poznań",
                "salary": (7500, 10500),
    ...
    # ── 25. WorkBridge Executive Search (EN)
    {
        ...
        "jobs": [
            {
                "title": "Managing Director — Logistics",
                "category": "ops_manager",
                "seniority": "executive",
                "loc": "Warszawa",
                "salary": (35000, 55000),
            ...
            },
            {
                ...
                "category": "eng_industrial",
                "seniority": "director",
                "loc": "Katowice",
                "salary": (25000, 38000),
            },
            {
                "title": "VP Sales — Eastern Europe",
            ...
            {
                "title": "Director of Operations (Pharma)",
                "category": "ops_manager",
                "seniority": "director",
                "loc": "Kraków",
                "salary": (26000, 40000),
...
FORM_TEMPLATE_DEFS: dict[str, dict[str, Any]] = {
    ...
    "production_pl": {
        ...
        "fields": [
            ...
            (
                "Uprawnienia (wybierz jakie posiadasz)",
                "multiselect",
                False,
                _opts(
                    "Wózki widłowe UDT",
            ...
            (
                ...
                "select",
                False,
                _opts("Tylko dzienna", "Tylko nocna", "Dowolna"),
            ),
    ...
    "driver_pl": {
        ...
        "fields": [
            ...
            (
                ...
                "multiselect",
                False,
                _opts("Angielski", "Niemiecki", "Rosyjski", "Inne"),
            ),
            (
                "Dyspozycyjność wyjazdowa",
                "select",
                False,
                _opts("Cały tydzień", "5/2", "Tylko weekendy"),
            ),
        ],
    },
    # ── Medical (PL)
    "medical_pl": {
        ...
        "fields": [
            ...
            (
                ...
                "select",
                True,
                _opts("Pełny etat", "3/4 etatu", "1/2 etatu", "Zlecenie / kontrakt"),
            ),
    ...
    "medical_en": {
        ...
        "fields": [
            ...
            (
                ...
                "select",
                True,
                _opts("Full-time", "Part-time 75%", "Part-time 50%", "Contract"),
            ),
    ...
    "hospitality_en": {
        ...
        "fields": [
            ...
            (
                ...
                "multiselect",
                True,
                _opts("English", "Polish", "German", "French", "Spanish", "Russian", "Italian"),
            ),
            (
                "Available shifts",
                "multiselect",
                True,
                _opts("Morning", "Evening", "Night", "Weekend"),
            ),
    ...
    "sales_pl": {
        ...
        "fields": [
            ...
            (
                ...
                "multiselect",
                False,
                _opts("Angielski", "Niemiecki", "Hiszpański", "Francuski", "Inne"),
            ),
        ],
    },
    "sales_en": {
        ...
        "fields": [
            ...
            (
                ...
                "multiselect",
                False,
                _opts("English", "Polish", "German", "Spanish", "French", "Other"),
            ),
        ],
    },
    ...
    "finance_en": {
        ...
        "fields": [
            ...
            (
                ...
                "multiselect",
                False,
                _opts("ACCA", "CFA", "CIA", "CIMA", "CPA", "FRM", "None"),
            ),
            ("Notice period (weeks)", "number", False, None),
            ("English level", "select", True, _opts("B2", "C1", "C2 / native")),
            ("LinkedIn URL", "text", False, None),
    ...
    "finance_pl": {
        ...
        "fields": [
            ...
            (
                ...
                "multiselect",
                False,
                _opts("Biegły rewident", "Doradca podatkowy", "ACCA", "CFA", "Aplikant", "Brak"),
            ),
            (
                "Znajomość systemów",
                "multiselect",
                False,
                _opts(
                    "SAP", "Comarch ERP", "enova365", "Symfonia", "Płatnik", "Excel zaawansowany"
                ),
            ),
            ("LinkedIn URL", "text", False, None),
        ],
    ...
    "teacher_pl": {
        ...
        "fields": [
            ...
            (
                ...
                False,
                _opts(
                    "CAE", "CPE", "DELF/DALF", "Goethe-Zertifikat", "DELE", "TKT", "CELTA", "Inne"
                ),
            ),
            ("Kwalifikacje pedagogiczne", "checkbox", False, None),
            ("Lata doświadczenia w nauczaniu", "number", True, None),
            (
                "Preferowani uczniowie",
                "multiselect",
                False,
                _opts("Przedszkole", "Dzieci", "Młodzież", "Dorośli", "Firmy / B2B"),
            ),
    ...
    "construction_en": {
        ...
        "fields": [
            ...
            (
                "Electrical SEP G1/G2/G3",
                "multiselect",
                False,
                _opts("SEP G1", "SEP G2", "SEP G3", "None"),
            ),
    ...
    "legal_pl": {
        ...
        "fields": [
            ...
            (
                ...
                "multiselect",
                False,
                _opts("Angielski", "Niemiecki", "Francuski", "Włoski", "Hiszpański"),
            ),
            ("LinkedIn URL", "text", False, None),
        ],
    },
    ...
    "beauty_en": {
        ...
        "fields": [
            ...
            (
                ...
                "multiselect",
                False,
                _opts("English", "Polish", "German", "Russian", "Other"),
            ),
        ],
    },
    # ── Security (PL)
    ...
    "automotive_pl": {
        ...
        "fields": [
            ...
            (
                "Diagnostyka komputerowa — doświadczenie",
                "select",
                False,
    ...
    "executive_search_en": {
        ...
        "fields": [
            ...
            (
                ...
                "multiselect",
                False,
                _opts("English", "Polish", "German", "French", "Other"),
            ),
            ("Notice period (weeks)", "number", False, None),
        ],
    },
    ...
    "logistics_pl": {
        ...
        "fields": [
            ...
            (
                ...
                "multiselect",
                False,
                _opts("SAP EWM", "Manhattan", "Comarch WMS", "Logito", "Brak / inny"),
            ),
            (
                "Preferowana zmiana",
                "select",
    ...
    "retail_pl": {
        ...
        "fields": [
            ...
            (
                ...
                "multiselect",
                False,
                _opts("Angielski", "Niemiecki", "Ukraiński", "Inny"),
            ),
...
def pick_template_for_job(category: str, company_lang: str, is_agency: bool) -> str:
    ...
    # Design / creative
    if (
        category.startswith("design_")
        or category.startswith("marketing_")
        and "copy" not in category
    ):
...
def render_job_content(company: dict, job: dict) -> dict[str, Any]:
    ...
    if lang == "pl":
        role_summary = (
            f"{company['name']} poszukuje osoby na stanowisko {title.lower()}. {company['blurb']}"
            if not is_agency
    ...
    async with Session() as db:
        ...
        for company_def in COMPANIES:
            ...
            for j in company_def["jobs"]:
                needed_archetypes.add(
                    pick_template_for_job(j["category"], company_def["lang"], is_agency)
                )
            ...
            print(
                f"  ✓ {display_name} — {len(company_def['jobs'])} ofert, {len(template_cache)} szablonów"
            )
            ...
            for job_def in company_def["jobs"]:
                ...
                default_contract = (
                    ...
                    if (
                        company_def["lang"] == "en"
                        and ("Engineer" in job_def["title"] or "Developer" in job_def["title"])
                    )
                    else "employment"
                )
                ...
                archetype = pick_template_for_job(
                    job_def["category"], company_def["lang"], is_agency
                )
